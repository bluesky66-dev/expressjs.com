...
<ul>
  ...
  <li markdown="1">The [req.ip](/expressjs.com/{{ page.lang }}/api.html#req.ip) and [req.ips](/expressjs.com/{{ page.lang }}/api.html#req.ips) values are populated based on the socket address and `X-Forwarded-For` header, starting at the first untrusted address.
  </li>
</ul>
