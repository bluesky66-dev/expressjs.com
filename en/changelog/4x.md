...
<ul>
  ...
  <li markdown="1" class="changelog-item">
  The [`res.download()` method](/expressjs.com/{{ page.lang }}/4x/api.html#res.download) now accepts an optional `options` object.
  </li>
...
<ul>
  ...
  <li markdown="1" class="changelog-item">
  The [`res.sendFile()` method](/expressjs.com/{{ page.lang }}/4x/api.html#res.sendFile) now accepts two new options: `acceptRanges` and `cacheControl`.
  ...
  <li markdown="1" class="changelog-item">
  The [`res.location()` method](/expressjs.com/{{ page.lang }}/4x/api.html#res.location) and [`res.redirect()` method](/expressjs.com/{{ page.lang }}/4x/api.html#res.redirect) will now URL-encode the URL string, if it is not already encoded.
  </li>

  <li markdown="1" class="changelog-item">
  The performance of the [`res.json()` method](/expressjs.com/{{ page.lang }}/4x/api.html#res.json) and [`res.jsonp()` method](/expressjs.com/{{ page.lang }}/4x/api.html#res.jsonp) have been improved in the common cases.
  </li>

  <li markdown="1" class="changelog-item">
  The [jshttp/cookie module](https://www.npmjs.com/package/cookie) (in addition to a number of other improvements) has been updated and now the [`res.cookie()` method](/expressjs.com/{{ page.lang }}/4x/api.html#res.cookie) supports the `sameSite` option to let you specify the [SameSite cookie attribute](https://tools.ietf.org/html/draft-west-first-party-cookies-07).  NOTE: This attribute has not yet been fully standardized, may change in the future, and many clients may ignore it.
  ...
  <li markdown="1" class="changelog-item">
  The [`req.range()` method](/expressjs.com/{{ page.lang }}/4x/api.html#req.range) options object now supports a `combine` option (`false` by default), which when `true`, combines overlapping and adjacent ranges and returns them as if they were specified that way in the header.
  </li>
</ul>
